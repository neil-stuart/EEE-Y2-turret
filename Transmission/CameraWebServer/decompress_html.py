...
bytes2640_gz = [0x1F, 0x8B, 0x08, 0x08, 0x50, 0x5C, 0xAE, 0x5C, 0x00, 0x03, 0x69, 0x6E, 0x64, 0x65, 0x78, 0x5F,
...
bytes = bytearray(bytes2640_gz)

text = gzip.decompress(bytes)

with open("index2640.html",'wb') as out:
    out.write(text)
